...
from PytorchSeg2D.models.vmamba import ENCODERS, VSSM
from PytorchSeg2D.models.vmamba.vmamba import VSSBlock, LayerNorm2d, Linear2d
...
if __name__ == '__main__':
    ...
    model = MSVMUNet(in_channels=2).to(DEVICE)
    output = model(x)
    print(output.shape)
